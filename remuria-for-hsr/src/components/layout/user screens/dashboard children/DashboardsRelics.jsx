      ...
      {relicShowcaseStyle &&
        ...
        >
          {relicsInfo === null
            ...
            : (relicsInfo === "error"
              ? <div className="col-span-full min-h-[65vh] flex items-center justify-center backdrop-blur-md border border-red-500 rounded-2xl afacad-bold text-white [container-type:size] bg-black/70 overflow-clip">
                  <motion.img
                    src={loadFail}
        ...
        <div className="w-full p-4">
          <div className="bg-gray-900/50 backdrop-blur-md border border-white/10 rounded-xl p-3">
            {relicsInfo === null
              ...
              : relicsInfo === "error"
                ? <div className="min-h-[65vh] flex items-center justify-center backdrop-blur-md border border-red-500 rounded-2xl afacad-bold text-white [container-type:size] bg-black/70 overflow-clip">
                    <motion.img
                      src={loadFail}
                      alt='Failed to load relics'
                      className='w-full object-contain'
