        ...
        <div className="absolute border border-[#B2B2B2]/40 bg-gray-800/40 backdrop-blur-md rounded-xl vmt-[170%] top-[115%] p-3 w-[270%] right-0">
            {authStatus?.authenticated ?
                <div className='flex flex-col gap-2'>
                    ...
                    {hsrUids.length > 0 && (
                        <div className="flex flex-col gap-1 border-t border-white/10 pt-2">
                            <p className="afacad-light text-white/30 text-xs uppercase tracking-wider">Linked HSR UIDs</p>
                            {hsrUids.map(uid => (
                                <p key={uid} className="afacad-light text-white/60 text-sm px-1">• {uid}</p>
                            ))}
                        </div>
                    )}

                    <div
                        className="border-t border-white/10 pt-2 text-white afacad-bold self-center rounded-xl py-1 px-3 flex items-center gap-2 hover:bg-[#dc8585]/20 cursor-pointer text-xl w-full justify-center"
                ...
                <div className='flex flex-col'>
                    ...
                    <a
                        className="text-white afacad-bold self-center mt-1 rounded-xl py-1 px-3 flex items-center gap-2 hover:bg-gray-600/20 cursor-pointer text-xl"
